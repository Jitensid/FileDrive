...
# URLS and their class based views
urlpatterns = [
    ...
    path('fetchstarredfiles/',
         api_views.FetchStarredFilesView.as_view(), name='fetchfiles'),
    path('deletefile/', api_views.DeleteFileView.as_view(), name='deletefile'),
    path('changefilestarstatus/', api_views.ChangeFileStarStatus.as_view(),
         name='changefilestarstatus')
]
